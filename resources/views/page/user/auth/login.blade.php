            ...
            <div class="d-flex align-items-stretch flex-wrap">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-4">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to Dashboard <span class="font-weight-bold">Antshop</span>
                        </h4>
                        ...
                        <form method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input id="email"
                                    type="email"
                                    class="form-control @error('email') is-ivalid @enderror"
                                    name="email"
                                    tabindex="1"
                                    autofocus>
                                @error('email')
                        ...
                        <div class="text-small mt-5 text-center">
                            Copyright &copy; Antshop. Made with 💙 by Stisla
                            <div class="mt-2">
